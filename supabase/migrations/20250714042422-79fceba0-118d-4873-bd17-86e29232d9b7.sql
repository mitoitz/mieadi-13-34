-- SECURITY FIXES MIGRATION (Updated)

-- 1. First, fix invalid role in member_requests
UPDATE member_requests 
SET requested_role = 'membro' 
...
-- 4. Add RLS policies for congregations
...
-- 5. Add RLS policies for courses
...
-- 6. Add RLS policies for subjects
...
-- 7. Add check constraint to prevent privilege escalation in member_requests
