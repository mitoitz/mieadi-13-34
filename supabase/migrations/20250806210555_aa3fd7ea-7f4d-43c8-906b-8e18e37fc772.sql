-- Ativar extensão pgcrypto para funções de criptografia
CREATE EXTENSION IF NOT EXISTS pgcrypto;

-- Adicionar coluna pin_hash se não existir
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS pin_hash text;

-- Remover a função anterior se existir
DROP FUNCTION IF EXISTS public.set_user_pin(text, text);

-- Criar função segura para definir PIN do usuário
...
BEGIN
    ...
    -- Gerar hash do PIN usando bcrypt com salt
...
-- Criar função para verificar PIN
