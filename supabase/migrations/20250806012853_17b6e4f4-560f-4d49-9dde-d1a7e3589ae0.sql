-- Desabilitar validação de telefone temporariamente
...
-- Atualizar CPFs vazios com valores únicos menores
UPDATE profiles 
SET cpf = CONCAT('000000', row_number() OVER (ORDER BY id)::text)
