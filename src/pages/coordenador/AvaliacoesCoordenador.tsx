...
interface AvaliacoesCoordenadorProps {
  user: {
    id: string;
    name: string;
    userType: string;
...
export function AvaliacoesCoordenador({ user }: AvaliacoesCoordenadorProps) {
  ...
  const loadTurmas = async () => {
    try {
      // Coordenador pode ver todas as turmas
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Gerencie avaliações de todas as turmas como coordenador
          </p>
        </div>
        ...
        <TabsContent value="avaliacoes" className="space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">
                Crie e gerencie avaliações para todas as turmas
              </p>
            </div>
            <Button 
        ...
        <TabsContent value="relatorios" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Visualize estatísticas e relatórios de todas as avaliações
              </CardDescription>
            </CardHeader>
            <CardContent>
